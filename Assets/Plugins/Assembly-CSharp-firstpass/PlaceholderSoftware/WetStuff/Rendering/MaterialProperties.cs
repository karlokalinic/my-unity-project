...
namespace PlaceholderSoftware.WetStuff.Rendering
{
	internal struct MaterialProperties : IEquatable<MaterialProperties>
	{
		...
		{
			return EqualityComparer<Vector4>.Default.Equals(XLayerScaleOffset, other.XLayerScaleOffset) && EqualityComparer<Texture2D>.Default.Equals(XLayer, other.XLayer) && EqualityComparer<Vector4>.Default.Equals(YLayerScaleOffset, other.YLayerScaleOffset) && EqualityComparer<Texture2D>.Default.Equals(YLayer, other.YLayer) && EqualityComparer<Vector4>.Default.Equals(ZLayerScaleOffset, other.ZLayerScaleOffset) && EqualityComparer<Texture2D>.Default.Equals(ZLayer, other.ZLayer) && EqualityComparer<Texture2D>.Default.Equals(BlueNoiseRgba, other.BlueNoiseRgba) && EqualityComparer<Vector2>.Default.Equals(RandomnessTiling, other.RandomnessTiling) && EqualityComparer<Vector2>.Default.Equals(SampleJitter, other.SampleJitter);
		}

		public override int GetHashCode()
		{
			int num = 47332817;
			num = num * -1521134295 + EqualityComparer<Vector4>.Default.GetHashCode(XLayerScaleOffset);
			num = num * -1521134295 + EqualityComparer<Texture2D>.Default.GetHashCode(XLayer);
			num = num * -1521134295 + EqualityComparer<Vector4>.Default.GetHashCode(YLayerScaleOffset);
			num = num * -1521134295 + EqualityComparer<Texture2D>.Default.GetHashCode(YLayer);
			num = num * -1521134295 + EqualityComparer<Vector4>.Default.GetHashCode(ZLayerScaleOffset);
			num = num * -1521134295 + EqualityComparer<Texture2D>.Default.GetHashCode(ZLayer);
			num = num * -1521134295 + EqualityComparer<Texture2D>.Default.GetHashCode(BlueNoiseRgba);
			num = num * -1521134295 + EqualityComparer<Vector2>.Default.GetHashCode(RandomnessTiling);
			return num * -1521134295 + EqualityComparer<Vector2>.Default.GetHashCode(SampleJitter);
		}
