...
namespace AC
{
	...
	public class SceneManager : ScriptableObject
	{
		...
		private void OnCreateBefore_NPC ()
		{
			...
			{
				CharacterWizardBridge.InitForNPC (Selection.activeGameObject);
			}
			else
			{
				CharacterWizardBridge.InitForNPC ();
			}
		}
		...
		private void OnCreateBefore_Player ()
		{
			if (Selection.activeGameObject != null && Selection.activeGameObject.GetComponent <Renderer> () && Selection.activeGameObject.GetComponent<Char> () == null)
			{
				CharacterWizardBridge.InitForPlayer (Selection.activeGameObject);
			}
			else
			{
				CharacterWizardBridge.InitForPlayer ();
			}
		}
