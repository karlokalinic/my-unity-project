...
namespace VLB
{
	...
	public class VolumetricDustParticles : MonoBehaviour
	{
		...
		public int particlesCurrentCount
		{
			get
			{
				return m_Particles ? m_Particles.particleCount : 0;
			}
		}
		...
		public int particlesMaxCount
		{
			get
			{
				return m_Particles ? m_Particles.main.maxParticles : 0;
			}
		}
		...
		private void SetParticleProperties()
		{
			...
			shape.length = num;
			shape.arc = 360f;
			shape.randomDirectionAmount = ((direction != Direction.Random) ? 0f : 1f);
